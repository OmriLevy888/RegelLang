...
public:
    ...
    : m_baseIndex(0), m_backlogIndex(0), m_actualIndex(0), m_usingBacklog(false), 
      m_tokenGenerator(std::move(tokenGenerator)), m_backlog()
    {}
    ...
    std::string toString() const override {
        return "TokenCollection<baseIndex: " + std::to_string(m_baseIndex) + ", backlogIndex: " +
                std::to_string(m_backlogIndex) + ", actualIndex: " + std::to_string(m_actualIndex) 
